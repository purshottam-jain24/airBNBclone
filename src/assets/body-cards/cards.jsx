    ...
    return (
        <div id='body-cards'>
            <div className="cards">
                ...
                {badgeText && <div className="image--badge">{badgeText}</div>}
                <div className="card-stats">
                    <div className="card-upper">
                        ...
                        <span>
                            ...
                            <span className='gray-card-stats'> ({props.item.stats.reviewCount}) • {props.item.location} </span>
                        </span>
                    </div>
                    <div className="card-lower">
                        <p>{props.item.title}</p>
                        <p><span className="card-lower-span">From ${props.item.price}</span> / person</p>
                    </div>
                </div>
            </div>
        </div>
